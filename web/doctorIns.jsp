        ...
        <div class="d-flex">
            ...
            <div class="w-100">
                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            <h1 class="mt-1"> Agregar Nuevo Doctor </h1>
                            <form action="Doctor" method="post"> 
                                <input type="hidden" name="accion" value="INS"/>
                                <div class="row">
                                    <div class="col-lg-6 mt-4">
                                        DNI:
                                        <input class="form-control" type="text" name="dni_doctor" value="${doctor.dni_doctor}"/>
                                        <br/>
                                        Nombre:
                                        ...
                                        <select class="form-control" name="especialidad_doctor">
                                            ...
                                            <option class="form-control"  value="Consulta Pediatrica">Consulta Pediatrica</option>
                                        </select>
                                        <br/>
                                        Telefono:
                                    ...
                                    <div class="col-lg-6 mt-4">
                                        ...
                                        <br/>
                                        Correo electronico:
                                        <input class="form-control" type="text" name="correo_doctor" value="${doctor.correo_doctor}"/>
                                        <br/>
                                        Contraseña:
                                    ...
                                    <div class="col-lg-12">
                                        <button class="btn btn-primary" type="submit" class="btn btn-primary" data-toggle="modal" 
                                                data-target="#alert" data-whatever="@mdo">Agregar</button> 

                                    </div>
                                </div>  
                                <!--button onclick="administradorUpd();" type="button" class="btn btn-primary" data-toggle="modal" 
                                data-target="#Mensaje" data-whatever="@mdo">Editar</button-->         
                            </form>
