                ...
                <div id="content">
                    <section class="py-3">
                        <div class="container">
                            ...
                            <a class="btn btn-primary  mt-4 mb-4" href="doctorIns.jsp">Agregar Nuevo</a>
                                ...
                                <thead>
                                    <tr class="color-title">
                                        ...
                                        <th>
                                            ...
                                            <a href="#" class="text-light text-center" onclick="doctorUpd();">Editar</a>
                                        </th>
                                        <th>
                                            <a href="#" class="text-light text-center" onclick="doctorDel();">Eliminar</a>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach var="f" items="${list}">
                                        <tr>
                                            ...
                                            <td class="text-center">${f.dni_doctor}</td>
                                            ...
                                            <td class="text-center">${f.correo_doctor}</td>
                                            <th>
